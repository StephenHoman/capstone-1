...
class __TwigTemplate_e2cc416efeab363f4807ab66cf56831dc4dcb3528397c55531a0ff55afcce89b extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Kill");
          ...
          <td>
            ";
            // line 51
            if ((0 !== twig_compare(twig_get_attribute($this->env, $this->source, $context["row"], "db", [], "any", false, false, false, 51), ""))) {
                // line 52
                echo "              ";
...
";
    ...
    {
        return new Source("", "server/status/processes/list.twig", "C:\\Program Files\\Ampps\\www\\Capstone\\capstone\\phpmyadmin\\templates\\server\\status\\processes\\list.twig");
    }
}
