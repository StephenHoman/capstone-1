...
class __TwigTemplate_210b41cdcafc86c13d7cd1722987810c6288ea677473c85e7e33e6db297ad5d0 extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("per minute:");
    ...
    ";
            // line 22
            if ((0 <= twig_compare(twig_get_attribute($this->env, $this->source, ($context["stats"] ?? null), "per_second", [], "any", false, false, false, 22), 1))) {
                // line 23
                echo "      <li>ø ";
...
";
    ...
    {
        return new Source("", "server/status/queries/index.twig", "C:\\Program Files\\Ampps\\www\\Capstone\\capstone\\phpmyadmin\\templates\\server\\status\\queries\\index.twig");
    }
}
