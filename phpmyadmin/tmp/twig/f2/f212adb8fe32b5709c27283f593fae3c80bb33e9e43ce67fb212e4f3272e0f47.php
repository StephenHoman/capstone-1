...
class __TwigTemplate_bec627248853e249ae25a8344efaf72cf64f63e7e42625c4f83f3ff1bf849332 extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Related links:");
          ...
          ";
                ...
                foreach ($context['_seq'] as $context["link_name"] => $context["link_url"]) {
                    // line 54
                    echo "            ";
                    if ((0 === twig_compare($context["link_name"], "doc"))) {
                        // line 55
                        echo "              ";
...
$context["variable"], "is_numeric", [], "any", false, false, false, 98) && (0 <= twig_compare(twig_get_attribute($this->env, $this->source, $context["variable"], "value", [], "any", false, false, false, 98), 1000)))) {
                    // line 99
                    echo "                  <abbr title=\"";
            ...
            <td class=\"w-50\">
              ...
              ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["doc"]) {
                    // line 126
                    echo "                ";
                    if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["doc"], "name", [], "any", false, false, false, 126), "doc"))) {
                        // line 127
                        echo "                  ";
...
";
    ...
    {
        return new Source("", "server/status/variables/index.twig", "C:\\Program Files\\Ampps\\www\\Capstone\\capstone\\phpmyadmin\\templates\\server\\status\\variables\\index.twig");
    }
}
